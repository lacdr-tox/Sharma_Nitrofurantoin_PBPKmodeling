...
modelingversion = "V4"
simul = "IV"
Simulationfile =read.delim(paste0(getwd(),"/",Modeling_dir, "/", simul,Species,modelingversion, "ExtrapolatedV4EHR.out"), header = TRUE, sep = "")
...
tiff(paste0(directory_i,"/", "FigS4",".png"), units="in",width=8, height=9, res=300, compression = 'lzw') 
print(P1)
dev.off()
