...
P2 = plot_function1(variable = c("cplasma", "P_excreted"),mainplot ="B.")

tiff(paste0(directory_i,"/", "FigureKOS8",".png"), units="in", width=8, height=13, res=300, compression = 'lzw') 
...
P2 = plot_function1(variable = c("cplasma", "cliver"),mainplot ="")
P2
