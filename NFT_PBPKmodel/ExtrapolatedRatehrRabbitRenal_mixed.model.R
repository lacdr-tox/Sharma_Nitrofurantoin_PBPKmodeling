...
#######################################################################
#Development of PBPK using MCsim model for NIT
#date: 16/05/22
#######################################################################

#%%%%%%%%%%specific notes for models%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#models for Rabbit Nitrofurantoin  
#Model version 5: generic model with only GFR based elimination and liver based metabolism in rabbits +  
...
Krestbody_plasma = 0.421;       #Rest of the body/blood partition coefficient	(fitted)
kgutabs = 0; 
frac = 0.5;
fu = 0.4149; #0.4149
QurineC = 13.45;
