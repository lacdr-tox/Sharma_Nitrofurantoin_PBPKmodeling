...
Species = "rats"
write.table(Simulationfile, file = paste0(getwd(),"/",Modeling_dir, "/", "Posterior_chains","/",Species,modelingversion, "ExtrapolatedV4Simulation.out"), row.names = F, sep = "\t")


# Simulationfile =read.delim(paste0(getwd(),"/",Modeling_dir, "/", Modeling_dir,Species,modelingversion, "ExtrapolatedV4Simulation.out"), header = TRUE, sep = "")
# head(Simulation)
