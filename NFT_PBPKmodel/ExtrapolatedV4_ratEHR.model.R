# PBPK model  for Rats include rat EHR mechanism
# this is the model with EHR and we used renal clearance and partition coefficient data form RabbitV4 model 
# This model is to fit the EHR data from rats
...
FQfilterate=0.0282;           #Fraction of glomeruler filteration L/hr/BW^0.75  # 20 pecent of kidney
...
Dynamics {
  ...
  dt(Agutlumen) = -kgutabsS*Agutlumen- kfeces*Agutlumen + ((oraldose1*BW))/expT +kbileS*ABile;   
