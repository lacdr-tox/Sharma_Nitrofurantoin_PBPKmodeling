#Forward simulation of the extrapolation from  ratsEHR  to rabbits again using model V4 + EHR using posterior paramters distribution 
...
level = ifelse(drugs == "rabbits",1,"NA") #here no role of level as this is non heirarchical methods 
...
# Simulationfile =read.delim(paste0(getwd(),"/",Modeling_dir,Modeling_dir, "/", "Posterior_chains","/",Species,modelingversion, "Simulation.out"), header = TRUE, sep = "")
# head(Simulation)
