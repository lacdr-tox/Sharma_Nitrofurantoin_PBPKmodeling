...
#Model version 3: generic model with only GFR based elimination and liver based metabolism in rabbits +  
#now we have added the reabsorption in the filterate comartment
...
Outputs = {cgut, cliver, cfat,ckidney,cfilterate, crestbody, cplasma,P_excreted,Massbalance,Reabsorption,Filteration,Total_renal_Cl,GFR_contribution,Re_GFR_contribution,Reabs_contribution};	
...
Dynamics {
  ...
  dt(Akidney) = Qkidney*cplasma*(fu/Kbp) - Qkidney*ckidney*((fu/Kbp)/Kkidney_plasma) -Filteration + Reabsorption;
  
  dt(Afilterate) = Filteration - Qfilterate*cfilterate -Reabsorption;
...
CalcOutputs { 
  Total_renal_Cl = Filteration - Reabsorption;
